...
const ContactUsDashboard = () => {
    ...
    const deleteMessage = id => {
        ...
        if (confirmation) {
            fetch(`https://dance-zone-server.vercel.app/contact-us/single-message/delete/${id}`, {
                method: 'DELETE',
                headers: {
    ...
    const handelContactUsModal = id => {
        fetch(`https://dance-zone-server.vercel.app/contact-us/single-massage-modal/${id}`)
            .then(res => res.json())
            .then(data => {
                if (data?.error) {
                    userLogout()
        ...
        fetch(`https://dance-zone-server.vercel.app/contact-us/single-massage-seen/${id}`, {
            method: "PUT",
            headers: {
                'content-type': 'application/json',
            },
