    ...
    const handleSubmit = async event => {
        ...
        if (paymentIntent.status === "succeeded") {
            ...
            fetch('https://dance-zone-server.vercel.app/student/selected-course/payment-info', {
                ...
                .then(res => res.json())
                .then(data => {
                    fetch(`https://dance-zone-server.vercel.app/student/course/available-seat-decrement/${courseId}`, {
                        method: 'PATCH',
                        headers: {
                            'content-type': 'application/json'
                        },
                    ...
                    fetch(`https://dance-zone-server.vercel.app/student/enroll/course/after-get-selected-course-if-exist/${courseId}`)
                        .then(res => res.json())
                        .then(data => {
                            if (data?._id) {
                                fetch(`https://dance-zone-server.vercel.app/student/delete/selected-course-if-exist/${data?._id}`, {
                                    method: 'DELETE',
                                    headers: { 'content-type': 'application/json' }
                                })
                                    .then(res => res.json())
