...
const User = () => {
    ...
    const makeAdmin = id => {
        fetch(`https://dance-zone-server.vercel.app/manage-user/update-role-admin/${id}`, {
            method: 'PATCH',
            headers: {
    ...
    const makeInstructor = id => {
        fetch(`https://dance-zone-server.vercel.app/admin/manage-user/update/view-status/${id}`, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json',
            }
        ...
        fetch(`https://dance-zone-server.vercel.app/manage-user/update-role-instructor/${id}`, {
            method: 'PATCH',
            headers: {
                'content-type': 'application/json',
            }
    ...
    const deleteUser = id => {
        ...
        if (confirmation) {
            fetch(`https://dance-zone-server.vercel.app/user/delete/${id}`, {
                method: 'DELETE',
                headers: {
                    'content-type': 'application/json',
                }
