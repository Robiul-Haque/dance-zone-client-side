...
const EditClass = () => {
    ...
    const editClass = data => {
        ...
        if (formData) {
            fetch(`http://localhost:5000/my-class/update-data/${_id}`, {
                method: 'PUT',
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <div className="card-body">
                        <h1 className="text-2xl font-bold text-center">Edit My Class!</h1>
                        <form onSubmit={handleSubmit(editClass)}>
                            ...
                            <div className="form-control mt-6">
                                <input type='submit' defaultValue='Update Class' className="btn btn-primary text-white" />
                            </div>
                        </form>
                    </div>
                </div>
