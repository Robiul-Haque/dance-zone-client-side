    ...
    return (
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 lg:w-80 md:w-64 w-60 h-full bg-base-200 text-base-content">
                    {/* Sidebar content here */}
                    <div className="flex justify-between">
                        <div>
                            <div className="flex lg:gap-x-5 md:gap-x-4 gap-x-2 mt-5">
                                {
                                    user?.displayName ? <h1 className="text-base font-medium mt-1">Hi, {user?.displayName}</h1> : <>Admin</>
                                }
                                {
                        ...
                        <label className="swap swap-rotate mt-4 ml-5">
